...
## Phase D 計画への含意 (D-0.5 修正後に更新)

1. **PRD-β scope**: Cluster 1b 20 件 + symbol 1 件 = 21 件
2. **PRD-γ scope**: `__type` 1 件
3. **PRD-δ scope**: excluded_user 72 件 + HTTPException 1 件の対応が必要
4. ~~`P` 残存の調査~~ ✅ 解消済
