...
| T2.A: PRD-A 実装 | **in progress** | - | T1-T5 / T7-T9 / T8' / T2.A-i 完了。Cluster 1a 8/11 解消。残 3 件 |
| T2.A-i: 外部 builtin JSON loader の scope push | **done** | 2026-04-08 | TNext / TResult / TResult1 / TResult2 (4 件) 解消 |
| T2.A-ii: interface call signature overload merge | **next** | - | E (FnSSGParamsOrSSGParams) (1 件) |
