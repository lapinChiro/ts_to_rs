...
| T2.A: PRD-A 実装 | **in progress** | - | T1-T5 / T7-T9 / T8' / T2.A-i / T2.A-ii 完了。Cluster 1a 10/11 解消。残 1 件 |
...
| T2.A-iv: expected type 経由の free type param 伝搬 | not started | - | E (SSGParamsMiddleware via expected type, 1 件) — 別 root cause |
...
#### Sub-cluster T2.A-iv: expected type 経由の free type param 伝搬 (1 件、未対応)
