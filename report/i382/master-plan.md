...
| T2.A: PRD-A 実装 | **in progress (paused)** | - | T1-T5 完了, T7-T9 + T8'実装完了, T11 実測で Cluster 1a 4/11 解消、残 7 件追跡待ち (下記) |
...
**最優先タスク**: 残 7 件 (`E`, `P`, `S`, `TNext`, `TResult`, `TResult1`, `TResult2`) の発生経路特定と修正。
