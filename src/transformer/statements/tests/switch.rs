...
//
// The walker rewrites nested bare `Stmt::Break { label: None, value: None }` within
// switch case body into `Stmt::Break { label: Some("__ts_switch"), value: None }`.
// Descent policy is exhaustive over 14 IR Stmt variants — see the helper's docstring.

mod i153_walker_tests {
