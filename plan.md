...
**次のアクション**: Batch 11a（I-368+I-369: OutputWriter types.rs 衝突 + ビルトイン型モノモーフィゼーション）
...
現状: S1 残 0 件、ディレクトリコンパイル残 2 ファイル（I-368: OutputWriter types.rs 衝突 + I-369: ビルトイン型モノモーフィゼーション未適用）
...
|-------|---------|---------|-----------|
| 11a | I-368+I-369 | OutputWriter types.rs 衝突 + ビルトイン型モノモーフィゼーション | dir compile 156→157+ のゲート |
