...
I-112c Phase 1-3 + I-211 + I-224 + I-266 実装済み（70→48 件）。残り 48 件を 3 つのイシューで段階解消。次のタスクから順に着手する。

### 開発順序

| 順序 | イシュー | 解消見込み | 理由 |
|---|---|---|---|
| 1 | **I-268 + I-269: ジェネリクス・Optional スプレッド展開** | ~18 件 | 型パラメータ制約解決 + Option unwrap。同一コードパス |
| 2 | **I-267: return/new 型逆引き** | ~10 件 | 戻り値型からの逆引き |

### 依存関係

I-268 と I-269 は同一 PRD にバッチ済み（`backlog/I-268-generic-and-optional-spread-expansion.md`）。
