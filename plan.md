...
**次のアクション**: Batch 9（I-282: デフォルトパラメータ lazy eval 設計不足）
...
現状: S1 残 0 件、ディレクトリコンパイル残 2 ファイル（I-273）
...
| Batch | イシュー | 根本原因 |
|-------|---------|---------|
| 9 | I-282 | デフォルトパラメータ lazy eval 設計不足。修正 1 箇所に集約済み |
| 10 | I-299+I-273 | convert_ts_type 型パラメータコンテキスト欠如。dir compile 156→157+の阻害 |
...
`git log` で詳細参照: Batch 1〜3b, R-1, C-4, T-1〜T-4, S1, D-1, 4a〜5b, 10b, 6, 6b, 7, 8, 14, 8b

---

## ベースライン（2026-04-05 計測）

| 指標 | Batch 6 時点 | Batch 8 時点 |
|------|-------------|-------------|
| Hono クリーン | 113/158 (71.5%) | 112/158 (70.9%) ※Hono upstream 変更 |
| エラーインスタンス | 54 | 56 ※CALL_TARGET +2 (upstream) |
| コンパイル(file) | 112/158 (70.9%) | 111/158 (70.3%) |
| コンパイル(dir) | 156/158 (98.7%) | 156/158 (98.7%) |
| テスト数 | 2043 | 2048 |
| コンパイルテストスキップ | 24 / 23 | 23 / 22（builtins なし / あり） |
