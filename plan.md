...
（backlog/ が空。下記ロードマップの次のイシューから PRD を作成する）
...
| 順序 | イシュー | 解消見込み | 理由 |
|---|---|---|---|
| 1 | **I-211: ECMAScript 標準型追加** | 11 件 | `Response`, `ReadableStream` 等のコンストラクタ引数型を TypeRegistry に追加。I-112c の型推定インフラが自動的に追加ケースをカバーする。レバレッジ最大 |
