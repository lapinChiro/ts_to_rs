...
1. `backlog/e2e-test-expansion.md` — E2E テストカバレッジの大幅拡充（I-63 + I-64）
2. `backlog/object-destructuring-extensions.md` — オブジェクト分割代入の拡張（I-14）
3. `backlog/type-guard-expression.md` — 型ガードの式変換（I-45）
