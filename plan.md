...
## 現在のフェーズ: Batch 25 (I-392) Phase 0-4 完了、Phase 5 待ち
...
### 次: Phase 5 (Marker struct + inner fn)

P5.1 `used_marker_names` → P5.2 ZST struct emission → P5.3 StructInit unit syntax →
P5.4 Inner fn emission
