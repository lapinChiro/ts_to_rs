...
## 現在のフェーズ: Batch 25 (I-392) Phase 0-5 完了、Phase 6 待ち
...
### 次: Phase 6 (Return wrap)

P6.0 `return_wrap_ctx` field → P6.1 ReturnWrapContext + wrap_leaf →
P6.2 Polymorphic None → P6.3 Expr::If wrap → P6.4 IfLet/Match 対応
