...
**Batch 4b: I-312b（convert_ts_type を TsTypeInfo 経由に統一）**

Batch 4 で構築した基盤（FieldDef/ParamDef、TsTypeInfo、TypeDef ジェネリック化）を使い、
convert_ts_type を TsTypeInfo 経由の 2 ステップに書き換え、registry から convert_ts_type を完全排除する。
...
| **4b** | **I-312b** | **convert_ts_type を TsTypeInfo 経由に統一** | **L2: 設計** | **← 次** |
...
| テスト数 | 1784（ユニット 1605 + コンパイル 3 + スナップショット 3 + E2E 84 + integration 89） |
