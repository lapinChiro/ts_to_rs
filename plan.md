...
1. **[I-211-b](backlog/i-211-b-ecmascript-extraction.md)**: ECMAScript 標準型の抽出 + JSON ファイル分割
2. **[I-211-c](backlog/i-211-c-verification.md)**: 検証 + E2E テスト + ベンチマーク効果測定
...
| 順序 | イシュー | 解消見込み | 理由 |
|---|---|---|---|
| 1 | **I-211: ECMAScript 標準型追加** | 11 件 | ECMAScript 標準型の TypeRegistry 追加。I-211-a（オーバーロード対応 + union 合成 enum 変換）完了済み。残り I-211-b/c |
