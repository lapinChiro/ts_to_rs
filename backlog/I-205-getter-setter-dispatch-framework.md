...
- **Completion criteria**: cell 9, 18 unit test green + (11-b) Mixed class reachability audit 結論 + (11-c) Static × {B3/B6/B7/None field} matrix cell 明示 + tsc oracle observation embed + per-cell E2E fixture
- **Depends on**: T1, T5, T6
