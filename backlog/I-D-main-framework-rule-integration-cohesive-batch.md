...
| 9 | v4-3 | T2-2 (spec-stage-adversarial-checklist.md: Rule 9 (a) wording 強化) + T1-6 (audit: verify_dispatch_arm_mapping_table 新設) | `tests/i_d_main_rule_wording_test.rs::test_rule9_dispatch_arm_mapping_table_documented` + `tests/i_d_main_audit_extensions_test.rs::test_audit_dispatch_arm_mapping_completeness_one_to_one` | self-applied: 本 PRD 上の dispatch arm mapping table (= 本 table 自身) で 24-cell 1-to-1 mapping (本 I-D-main scope cells のみ) PASS、I-D-pre 5 cells は対応 I-D-pre PRD で別 verify |
