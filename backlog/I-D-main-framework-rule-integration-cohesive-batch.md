...
- `scripts/audit-prd-rule10-compliance.py`: 1033 行 (post I-D-pre Phase 3 + 2026-05-12 Rules 改善 batch coordinate sync) → ~1300 行見込み (= 9 new functions + 1 existing strengthening + helper utilities 抽出、Path B split 後 I-D-main scope のみ)
